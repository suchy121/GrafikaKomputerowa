...

{
	...
	// wczytanie tekstury old_man_white_skin_mustache.tga

	GLboolean error = load_targa("old_man_white_skin_mustache.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku old_man_white_skin_mustache.tga");
	...
	error = load_targa("old_man_white_skin_mustache.tga", width, height, format, type, pixels);
